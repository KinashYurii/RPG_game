...
import static com.griddynamics.rpg.model.backpack.BackpackPlace.PLACE3x2;

@Getter
public class LeatherHeadArmor implements Head {
    ...
    private BackpackPlace backpackPlace = PLACE3x2;

    public LeatherHeadArmor(int level) {
        this.level = level;
        this.name = "Leather Head Armor " + level;
        this.agility = level;
